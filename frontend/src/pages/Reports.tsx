        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-7xl mx-auto">
                <header className="mb-8">
                    ...
                    <p className="text-gray-500 mt-2">Generate and download comprehensive reports with key metrics and insights</p>
                </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        >
                            <div className="text-center">
                                ...
                                <h3 className="font-semibold text-gray-900">Company Report</h3>
                                <p className="text-sm text-gray-500 mt-1">Full organization overview</p>
                            </div>
                        </button>
                        ...
                        >
                            <div className="text-center">
                                ...
                                <h3 className="font-semibold text-gray-900">Area Report</h3>
                                <p className="text-sm text-gray-500 mt-1">Department-specific analysis</p>
                            </div>
                        </button>
                        ...
                        >
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-500 mt-1">Individual performance</p>
                            </div>
                        </button>
                    </div>
                ...
                {previewHtml && (
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                            ...
                            <span className="text-sm text-gray-500">Use Print / Save as PDF to export as PDF</span>
                        </div>
                        <div className="p-4">
                            <iframe
                                srcDoc={previewHtml}
                ...
                <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                        <li><strong>Company Report:</strong> Includes overall eNPS, favorability, demographics breakdown, and top/bottom performing areas.</li>
                        <li><strong>Area Report:</strong> Shows area-specific metrics with comparison to company averages and employee list.</li>
                        <li><strong>Employee Report:</strong> Individual performance with comparison to company and area averages, plus survey history.</li>
                        <li><strong>Tip:</strong> Use "Print / Save as PDF" to save the report as a PDF file using your browser's print functionality.</li>
                    </ul>
                </div>
            </div>
        </div>
